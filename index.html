             ...
             <td>
                 <table  class="renk" width="1170" height="30" align="center" border="0" celpadding="0" cellspacing="0">
                     <tr>
                        ...
                        <td width="85" class="MaviAlanMenusu"><a href="xxxx" >Giriş Yap</a></td>
                        ...
                        <td width="130" class="MaviAlanMenusu"><a href="xxxx" >Alışveriş Sepeti</a> </td>
                     </tr>
                 </table>
                     ...
                     <tr class="renk2" width="1000">
                        ...
                        <table width="870"  height="30" align="center" border="0" celpadding="0" cellspacing="0">
                             <tr>
                                ...
                                <td width="200"  class="AnaMenu"><a href="xxxx">HEDİYE KARTLARI</a></td>
                                <td width="190"  class="AnaMenu"><a href="xxxx">KOKULU MUMLAR</a></td>
                                <td width="150"  class="AnaMenu"><a href="xxxx">AKSESUAR</a></td>
                                <td width="100"  class="AnaMenu"><a href="xxxx">TEALİGHT</a></td>
                           </tr>
                        </table>
                        </td
                     </tr>
        ...
        <tr  height="210">  
             <td><table width="1170" class="footer"  align="center" border="0" celpadding="0" cellspacing="0">
                             <tr height="30">
                                 ...
                                 <td>&nbsp;</td>
                                 <td class="AltMenu"><a href="xxxx">Üye Girişi</a></td>
                                 <td>&nbsp;</td>
