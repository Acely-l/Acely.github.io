...
<?php 
$vericek = $veritabanibaglantisi->query("SELECT * FROM urunler4 order by id desc limit 15", PDO::FETCH_ASSOC);
$DonguSayisi=1;
$SutunAdetSayisi=3;
...
?>
    <td width="200">
         <table border="0" align="center" cellpading="0" cellspacing="0"  >
            ...
            <tr height="170">
                <td  align="center" valign="center"><img src="urunler4/<?php echo DonusumGeriDondur($row["urunresmi"]);?>" border="0"></td>
            </tr>
            <tr height="25">            
